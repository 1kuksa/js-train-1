...
function checkDataType(value) {
  ...
  let s = typeof value;
  console.log(`Значення ${value} має тип ${s}`);
  return s
}
...
function getVariableType(variable) {
	let s = typeof variable;
	return s === "number" ? "Це число" : s === "string" ? "Це рядок" : s === "boolean" ? "Це булеве значення" : "Це інший тип";
...
console.log("factorial(5)", factorial(1)); // Виведе: 120
